<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v6_1_vivek_99.aspx.cs" Inherits="GreetingsWebApp.VIVEK.v6_1_vivek_99" %>
...
<body>
    ...
    <div>
           ...
           Choose a border Style:<br />
            ...
            <asp:Button ID="Update" runat="server" Text="Generate"  PostBackUrl="~/VIVEK/v6_2_vivek_99.aspx" />
            <br />
            <br />
    </div>
    </form>

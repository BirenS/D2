...
{
    public partial class v5_redirected_107 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            // Update the color.  
            pnlCard.BackColor = Color.FromName(Request.QueryString["color"]);
            // Update the font.        
            lblGreeting.Font.Name = Request.QueryString["fname"];
            if (Int32.Parse(Request.QueryString["fsize"]) > 0)
            {
                lblGreeting.Font.Size = FontUnit.Point(Int32.Parse(Request.QueryString["fsize"]));
            }
            ...
            pnlCard.BorderStyle = (BorderStyle)converter.ConvertFromString(Request.QueryString["border"]);
            ...
            if (Request.QueryString["pic"] == "True")
            {
            ...
            // Set the text.     
            lblGreeting.Text = Request.QueryString["text"];
            UpdateCard();

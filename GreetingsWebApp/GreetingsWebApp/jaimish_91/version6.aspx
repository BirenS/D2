<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="version6.aspx.cs" Inherits="GreetingsWebApp.jaimish_91.version6" %>
...
<body>
    ...
    <div>
     <!-- Here are the controls: -->
            ...
            <asp:Button ID="cmdUpdate"  runat="server" Width="71px" Height="24px" Text="Update" PostBackUrl="version61.aspx" />
    </div>
    </form>
</body>
</html>

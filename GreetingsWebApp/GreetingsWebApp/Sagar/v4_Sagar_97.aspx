<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v4_Sagar_97.aspx.cs" Inherits="GreetingsWebApp.Sagar.v4_Sagar_97" %>
...
<body>
    ...
    <div>
           <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="2" OnFinishButtonClick="FinishButtonClick">
            <WizardSteps>
                <asp:WizardStep runat="server" title="Step 1"> Choose Foreground Color:<br />
                     <asp:DropDownList ID="FClist" runat="server"></asp:DropDownList>
                    <br />
                    Choose a background color:<br />
                    <asp:DropDownList ID="BClist" runat="server"  ></asp:DropDownList><br />
                </asp:WizardStep>
             ...
             <asp:WizardStep runat="server" Title="GreetingCard" StepType="Complete">
